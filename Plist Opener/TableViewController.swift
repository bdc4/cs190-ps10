...
class TableViewController: UITableViewController {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        do{
            ...
            destinationViewController.errorText = "File does not exist."
        } catch TitledPlistReaderError.BadPlist {
            destinationViewController.errorText = "Bad Plist."
        } catch TitledPlistReaderError.UntitledPlist {
            destinationViewController.errorText = "Untitled Plist"
        } catch {
            destinationViewController.errorText = "Error"
        }
